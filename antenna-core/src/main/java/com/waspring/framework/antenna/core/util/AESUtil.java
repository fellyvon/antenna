...
public class AESUtil {
	...
	private static final String encodeRules = "hu8hu";

	/**
	 * 加密 1.构造密钥生成器 2.根据ecnodeRules规则初始化密钥生成器 3.产生密钥 4.创建和初始化密码器 5.内容加密 6.返回字符串
	 */
	public static String AESEncode(String content) {/// 默认密钥 encodeRules="hu8hu"
	 ...
	 */
	public static String AESDecode(String content) {/// 默认密钥 encodeRules="hu8hu"
